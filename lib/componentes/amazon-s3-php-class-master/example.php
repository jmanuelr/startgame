...
// AWS access info
if (!defined('awsAccessKey')) define('awsAccessKey', 'AKIAIFGPL2Q7C4KPBU3Q');//sizeind
if (!defined('awsSecretKey')) define('awsSecretKey', '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');

$uploadFile = dirname(__FILE__).'/S3.php'; // File to upload, we'll use the S3 class since it exists
$bucketName = uniqid('sizebay-images'); // Temporary bucket
