...
class Classificacao extends ObjetoDados{}
class ClassificacaoBD extends ManipulacaoDados{
	
	// ---- PROPRIEDADES -----
	public static $campos = array(
		array('nome' => 'cls_id',			'tipo' => 'num', 	'atributo' => 'Id', 	'extra' => 'primaria autoinc'),
		array('nome' => 'cls_nome',			'tipo' => 'alfa', 	'atributo' => 'Nome'),
		array('nome' => 'cls_status',		'tipo' => 'alfa', 	'atributo' => 'Status')
	);
	public static $tabela = array('nome' => 'gnb_classificacao', 'classe' => 'Classificacao');
	//-----------------------------------------------------------------------------------------------	
	// ---- METODOS DA CLASSE-----
