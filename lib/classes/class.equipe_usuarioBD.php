...
class EquipeUsuario extends ObjetoDados{}
class EquipeUsuarioBD extends ManipulacaoDados{
	
	// ---- PROPRIEDADES -----
	public static $campos = array(
		array('nome' => 'esr_id_eqp',			'tipo' => 'num', 	'atributo' => 'Equipe', 	'extra' => 'primaria estrangeira', 'classe' => 'Equipe', 	'arquivo_classe' => 'class.equipeBD.php'),
		array('nome' => 'esr_id_usr',			'tipo' => 'num', 	'atributo' => 'Usuario', 	'extra' => 'primaria estrangeira', 'classe' => 'Usuario', 	'arquivo_classe' => 'class.usuarioBD.php'),
		array('nome' => 'esr_status',			'tipo' => 'alfa', 	'atributo' => 'Status')
	);
	public static $tabela = array('nome' => 'gnb_equipe_usuario', 'classe' => 'EquipeUsuario');
	//-----------------------------------------------------------------------------------------------	
	// ---- METODOS DA CLASSE-----
