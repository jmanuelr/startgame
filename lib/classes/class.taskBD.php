...
class Task extends ObjetoDados{}
class TaskBD extends ManipulacaoDados{

	// ---- PROPRIEDADES -----
	public static $campos = array(
		array('nome' => 'tsk_id',				'tipo' => 'num', 	'atributo' => 'Id', 	 	'extra' => 'primaria autoinc'),
		array('nome' => 'tsk_dt_registro',		'tipo' => 'alfa', 	'atributo' => 'DtRegistro'),
		array('nome' => 'tsk_id_tsk',			'tipo' => 'num', 	'atributo' => 'Task', 	 	'extra' => 'estrangeira', 'arquivo_classe' => 'class.taskBD.php'),
		array('nome' => 'tsk_id_fse',			'tipo' => 'num', 	'atributo' => 'Fase', 	 	'extra' => 'estrangeira', 'arquivo_classe' => 'class.faseBD.php'),
		array('nome' => 'tsk_id_wrk',			'tipo' => 'num', 	'atributo' => 'Workflow', 	'extra' => 'estrangeira', 'arquivo_classe' => 'class.workflowBD.php'),
		array('nome' => 'tsk_id_cln',			'tipo' => 'num', 	'atributo' => 'Cliente', 	'extra' => 'estrangeira', 'arquivo_classe' => 'class.clienteBD.php'),
		array('nome' => 'tsk_id_usr',			'tipo' => 'num', 	'atributo' => 'Usuario', 	'extra' => 'estrangeira', 'arquivo_classe' => 'class.usuarioBD.php'),
		array('nome' => 'tsk_seq',				'tipo' => 'num', 	'atributo' => 'Seq'),
		array('nome' => 'tsk_titulo',			'tipo' => 'alfa', 	'atributo' => 'Titulo'),
		array('nome' => 'tsk_descricao',		'tipo' => 'alfa', 	'atributo' => 'Descricao'),
		array('nome' => 'tsk_tipo',				'tipo' => 'alfa', 	'atributo' => 'Tipo'),
		array('nome' => 'tsk_option',			'tipo' => 'alfa', 	'atributo' => 'Option'),
		array('nome' => 'tsk_required',			'tipo' => 'alfa', 	'atributo' => 'Required'),
		array('nome' => 'tsk_status',			'tipo' => 'alfa', 	'atributo' => 'Status'),
		array('nome' => 'tsk_deal_hash',		'tipo' => 'alfa', 	'atributo' => 'DealHash')
	);
	public static $tabela = array('nome' => 'gnb_task', 'classe' => 'Task');
	//-----------------------------------------------------------------------------------------------
	// ---- METODOS DA CLASSE-----
