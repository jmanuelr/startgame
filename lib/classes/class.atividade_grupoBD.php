...
class AtividadeGrupo extends ObjetoDados{}
class AtividadeGrupoBD extends ManipulacaoDados{
	
	// ---- PROPRIEDADES -----
	public static $campos = array(
		array('nome' => 'agr_id',			'tipo' => 'num', 	'atributo' => 'Id', 			'extra' => 'primaria autoinc'),
		array('nome' => 'agr_id_cls',		'tipo' => 'num', 	'atributo' => 'Classificacao', 	'extra' => 'estrangeira', 'classe' => 'Classificacao', 'arquivo_classe' => 'class.classificacaoBD.php'),
		array('nome' => 'agr_nome',			'tipo' => 'alfa', 	'atributo' => 'Nome'),
		array('nome' => 'agr_status',		'tipo' => 'alfa', 	'atributo' => 'Status')
	);
	public static $tabela = array('nome' => 'gnb_atividade_grupo', 'classe' => 'AtividadeGrupo');
	//-----------------------------------------------------------------------------------------------	
	// ---- METODOS DA CLASSE-----
