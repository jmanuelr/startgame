...
class Antropometria extends ObjetoDados{}
class AntropometriaBD extends ManipulacaoDados{
	
	// ---- PROPRIEDADES -----
	public static $campos = array(
		array('nome' => 'ant_id',				'tipo' => 'num', 	'atributo' => 'Id', 	'extra' => 'primaria autoinc'),
		array('nome' => 'ant_nome',				'tipo' => 'alfa', 	'atributo' => 'Nome'),
		array('nome' => 'ant_descricao',		'tipo' => 'alfa', 	'atributo' => 'Descricao'),
		array('nome' => 'ant_status',			'tipo' => 'alfa', 	'atributo' => 'Status')
	);
	public static $tabela = array('nome' => 'gnb_antropometria', 'classe' => 'Antropometria');
	//-----------------------------------------------------------------------------------------------	
	// ---- METODOS DA CLASSE-----
