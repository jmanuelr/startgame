...
class Regiao extends ObjetoDados{}
class RegiaoBD extends ManipulacaoDados{
	
	// ---- PROPRIEDADES -----
	public static $campos = array(
		array('nome' => 'reg_id',			'tipo' => 'num', 	'atributo' => 'Id', 	'extra' => 'primaria autoinc'),
		array('nome' => 'reg_nome',			'tipo' => 'alfa', 	'atributo' => 'Nome')
	);
	public static $tabela = array('nome' => 'gnb_regiao', 'classe' => 'Regiao');
	//-----------------------------------------------------------------------------------------------	
	// ---- METODOS DA CLASSE-----
