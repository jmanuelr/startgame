...
class Opcao extends ObjetoDados{}
class OpcaoBD extends ManipulacaoDados{
	
	// ---- PROPRIEDADES -----
	public static $campos = array(
		array('nome' => 'opc_id',				'tipo' => 'num', 	'atributo' => 'Id', 	'extra' => 'primaria autoinc'),
		array('nome' => 'opc_id_txt',			'tipo' => 'num', 	'atributo' => 'IdTxt'),
		array('nome' => 'opc_ordem',			'tipo' => 'num', 	'atributo' => 'Ordem'),
		array('nome' => 'opc_resposta',			'tipo' => 'alfa', 	'atributo' => 'Resposta'),
		array('nome' => 'opc_tooltip',			'tipo' => 'alfa', 	'atributo' => 'Tooltip'),
		array('nome' => 'opc_flag_extra',		'tipo' => 'alfa', 	'atributo' => 'FlagExtra'),
		array('nome' => 'opc_peso',				'tipo' => 'num', 	'atributo' => 'Peso'),
		array('nome' => 'opc_status',			'tipo' => 'alfa', 	'atributo' => 'Status')
	);
	public static $tabela = array('nome' => 'gnb_opcao', 'classe' => 'Opcao');
	//-----------------------------------------------------------------------------------------------	
	// ---- METODOS DA CLASSE-----
