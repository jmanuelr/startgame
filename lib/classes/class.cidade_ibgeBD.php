...
class Cidade extends ObjetoDados{}
class CidadeBD extends ManipulacaoDados{

	// ---- PROPRIEDADES -----
	public static $campos = array(
		array('nome' => 'cdd_id',				'tipo' => 'num', 	'atributo' => 'Id', 	'extra' => 'primaria autoinc'),
		array('nome' => 'cdd_uf',				'tipo' => 'alfa', 	'atributo' => 'Uf'),
		array('nome' => 'cdd_cod_ibge',			'tipo' => 'num', 	'atributo' => 'CodIbge'),
		array('nome' => 'cdd_nome',				'tipo' => 'alfa', 	'atributo' => 'Nome'),
		array('nome' => 'cdd_status',			'tipo' => 'alfa', 	'atributo' => 'Status')
	);
	public static $tabela = array('nome' => 'gnb_cidade_ibge', 'classe' => 'CidadeIbge');
	//-----------------------------------------------------------------------------------------------
	// ---- METODOS DA CLASSE-----
