...
class Janela extends ObjetoDados{}
class JanelaBD extends ManipulacaoDados{
	
	// ---- PROPRIEDADES -----
	public static $campos = array(
		array('nome' => 'jnl_id',				'tipo' => 'num', 	'atributo' => 'Id', 	'extra' => 'primaria autoinc'),
		array('nome' => 'jnl_id_sis',			'tipo' => 'num', 	'atributo' => 'Sistema', 'extra' => 'estrangeira', 'arquivo_classe' => 'class.sistemaBD.php'),
		array('nome' => 'jnl_nome',				'tipo' => 'alfa', 	'atributo' => 'Nome'),
		array('nome' => 'jnl_url',				'tipo' => 'alfa', 	'atributo' => 'Url'),
		array('nome' => 'jnl_ordem',			'tipo' => 'num', 	'atributo' => 'Ordem'),
		array('nome' => 'jnl_status',			'tipo' => 'alfa', 	'atributo' => 'Status')
	);
	public static $tabela = array('nome' => 'gnb_janela', 'classe' => 'Janela');
	//-----------------------------------------------------------------------------------------------	
	// ---- METODOS DA CLASSE-----
