<?
    ...
    if($obj_act == "lst"){
	    ...
	    //--------------------------------------------------------------------------
        $condicao           = "cln_id_cln = ".$_SESSION["sss_usr_id_cln"];
        ...
        if($txt_search!=""){
            ...
            $condicao .= " (";
            $condicao .= " cln_nome LIKE '%".$txt_search."%'";
            $condicao .= " cln_razao_social LIKE '%".$txt_search."%'";
            $condicao .= " )";
        }//if
        if($slc_search_status!=""){
            if($condicao!="")$condicao.=" AND";
            $condicao .= " cln_status = '".$slc_search_status."'";
        }//if
        //--------------------------------------------------------------------------
        $oListaObjetos      = ClienteBD::getLista($condicao, "cln_nome", $inicio, $max);
