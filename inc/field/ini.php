<?
    ...
    if($obj_act == "lst"){
	    ...
	    //--------------------------------------------------------------------------
        $condicao           = "fld_id_cln = ".$_SESSION["sss_usr_id_cln"];
        ...
        if($txt_search!=""){
            ...
            $condicao .= " (";
            $condicao .= " fld_nome LIKE '%".$txt_search."%'";
            $condicao .= " fld_descricao LIKE '%".$txt_search."%'";
            $condicao .= " )";
        }//if
        if($slc_search_status!=""){
            if($condicao!="")$condicao.=" AND";
            $condicao .= " fld_status = '".$slc_search_status."'";
        }//if
        //--------------------------------------------------------------------------
        $oListaObjetos      = FieldBD::getLista($condicao, "fld_nome", $inicio, $max);
