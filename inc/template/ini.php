<?
    ...
    if($obj_act == "lst"){
	    ...
	    //--------------------------------------------------------------------------
        $condicao           = "tmp_id_cln = ".$_SESSION["sss_usr_id_cln"];
        $condicao           .= " AND tmp_tipo = 'E'";
        ...
        if($txt_search!=""){
            ...
            $condicao .= " (";
            $condicao .= " tmp_titulo LIKE '%".$txt_search."%'";
            $condicao .= " )";
        }//if
        if($slc_search_status!=""){
            if($condicao!="")$condicao.=" AND";
            $condicao .= " tmp_status = '".$slc_search_status."'";
        }//if
        //--------------------------------------------------------------------------
        $oListaObjetos      = TemplateBD::getLista($condicao, "tmp_titulo", $inicio, $max);
