<?
    ...
    if($obj_act == "lst"){
	    ...
	    //--------------------------------------------------------------------------
        //$condicao           = "usr_id_cln = ".$_SESSION["sss_usr_id_cln"];
        $condicao           = "usr_id = ".$_SESSION["sss_usr_id"];
        ...
        if($txt_search!=""){
            ...
            $condicao .= " (";
            $condicao .= " usr_nome LIKE '%".$txt_search."%'";
            $condicao .= " )";
        }//if
        if($slc_search_status!=""){
            if($condicao!="")$condicao.=" AND";
            $condicao .= " usr_status = '".$slc_search_status."'";
        }//if
        //--------------------------------------------------------------------------
        $oListaObjetos      = UsuarioBD::getLista($condicao, "usr_nome", $inicio, $max);
        ...
        if($obj_id!=$_SESSION["sss_usr_id"]){
            $obj_id = $_SESSION["sss_usr_id"];
        }//if

        $oObjeto = UsuarioBD::get($obj_id);
