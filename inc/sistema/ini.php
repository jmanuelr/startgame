<?
    ...
    if($obj_act == "lst"){
	    ...
	    //--------------------------------------------------------------------------
        $condicao           = "sis_id_cln = ".$_SESSION["sss_usr_id_cln"];
        ...
        if($txt_search!=""){
            ...
            $condicao .= " (";
            $condicao .= " sis_nome LIKE '%".$txt_search."%'";
            $condicao .= " )";
        }//if
        if($slc_search_status!=""){
            if($condicao!="")$condicao.=" AND";
            $condicao .= " sis_status = '".$slc_search_status."'";
        }//if
        //--------------------------------------------------------------------------
        $oListaObjetos      = SistemaBD::getLista($condicao, "sis_nome", $inicio, $max);
